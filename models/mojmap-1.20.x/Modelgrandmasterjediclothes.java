...
public class Modelgrandmasterjediclothes<T extends Entity> extends EntityModel<T> {
	...
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "grandmasterjediclothes"), "main");
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition body_r1 = body
				.addOrReplaceChild("body_r1",
						...
						PartPose.offsetAndRotation(0.0F, -0.5F, 0.5F, 0.4363F, 0.0F, 0.0F));

		PartDefinition body_r2 = body
				.addOrReplaceChild("body_r2",
						CubeListBuilder.create().texOffs(42, 0).addBox(-5.0F, 0.0F, -0.5F, 10.0F, 15.0F, 1.0F,
								new CubeDeformation(0.0F)),
						PartPose.offsetAndRotation(0.0F, 0.5F, 3.0F, 0.1745F, 0.0F, 0.0F));

		PartDefinition body_r3 = body
				.addOrReplaceChild("body_r3",
						CubeListBuilder.create().texOffs(16, 32).addBox(-4.0F, -6.0F, -2.0F, 8.0F, 12.0F, 4.0F,
		...
		PartDefinition leftArm_r2 = leftArm.addOrReplaceChild("leftArm_r2",
				CubeListBuilder.create().texOffs(0, 54).addBox(-2.5F, -2.0F, -3.0F, 5.0F, 4.0F, 6.0F,
						new CubeDeformation(0.0F)),
		...
		PartDefinition leftArm_r3 = rightArm.addOrReplaceChild("leftArm_r3",
				CubeListBuilder.create().texOffs(0, 54).addBox(-2.5F, -2.0F, -3.0F, 5.0F, 4.0F, 6.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(1.5F, -1.0F, 0.0F, 3.1416F, 0.0F, -2.8362F));

		PartDefinition leftArm_r4 = rightArm.addOrReplaceChild("leftArm_r4",
				CubeListBuilder.create().texOffs(0, 16).addBox(-2.0F, -6.0F, -2.0F, 4.0F, 12.0F, 4.0F,
						new CubeDeformation(0.7F)),
