...
public class Modelclonebase<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in
	// the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(
			new ResourceLocation("modid", "clonebase"), "main");
	...
	public Modelclonebase(ModelPart root) {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition head_r1 = head
				.addOrReplaceChild("head_r1",
						CubeListBuilder.create().texOffs(32, 6).addBox(-4.0F, -2.0F, -4.0F, 8.0F, 2.0F, 8.0F,
								new CubeDeformation(0.6F)),
						PartPose.offsetAndRotation(0.0F, 0.0F, -0.5F, 0.5236F, 0.0F, 0.0F));

		PartDefinition head_r2 = head.addOrReplaceChild("head_r2",
				CubeListBuilder.create().texOffs(0, 77).addBox(-1.0F, -1.5F, -4.0F, 2.0F, 3.0F, 8.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(0.0F, -9.0F, 0.5F, -0.1745F, 0.0F, 0.0F));
