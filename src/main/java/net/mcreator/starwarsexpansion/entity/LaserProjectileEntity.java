...
import net.mcreator.starwarsexpansion.procedures.LaserProjectileProjectileHitsBlockProcedure;
...
public class LaserProjectileEntity extends AbstractArrow implements ItemSupplier {
	...
	public LaserProjectileEntity(PlayMessages.SpawnEntity packet, Level world) {
		super(StarWarsExpansionModEntities.LASER_PROJECTILE.get(), world);
	}
	...
	public void onHitEntity(EntityHitResult entityHitResult) {
		...
		LaserProjectileProjectileHitsBlockProcedure.execute(this.level(), this.getX(), this.getY(), this.getZ());
	}

	@Override
	public void onHitBlock(BlockHitResult blockHitResult) {
		super.onHitBlock(blockHitResult);
		LaserProjectileProjectileHitsBlockProcedure.execute(this.level(), blockHitResult.getBlockPos().getX(), blockHitResult.getBlockPos().getY(), blockHitResult.getBlockPos().getZ());
	}
	...
	public static LaserProjectileEntity shoot(Level world, LivingEntity entity, RandomSource random, float power, double damage, int knockback) {
		LaserProjectileEntity entityarrow = new LaserProjectileEntity(StarWarsExpansionModEntities.LASER_PROJECTILE.get(), entity, world);
	...
	public static LaserProjectileEntity shoot(LivingEntity entity, LivingEntity target) {
		LaserProjectileEntity entityarrow = new LaserProjectileEntity(StarWarsExpansionModEntities.LASER_PROJECTILE.get(), entity, entity.level());
