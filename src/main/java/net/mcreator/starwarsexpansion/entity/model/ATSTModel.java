...
public class ATSTModel extends GeoModel<ATSTEntity> {
	@Override
	public ResourceLocation getAnimationResource(ATSTEntity entity) {
		return new ResourceLocation("star_wars_expansion", "animations/atst.animation.json");
	}

	@Override
	public ResourceLocation getModelResource(ATSTEntity entity) {
		return new ResourceLocation("star_wars_expansion", "geo/atst.geo.json");
	}

	@Override
	public ResourceLocation getTextureResource(ATSTEntity entity) {
		return new ResourceLocation("star_wars_expansion", "textures/entities/" + entity.getTexture() + ".png");
	}

	@Override
	public void setCustomAnimations(ATSTEntity animatable, long instanceId, AnimationState animationState) {
