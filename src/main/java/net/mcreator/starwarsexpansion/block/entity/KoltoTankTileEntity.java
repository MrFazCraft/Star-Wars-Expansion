...
public class KoltoTankTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public KoltoTankTileEntity(BlockPos pos, BlockState state) {
		super(StarWarsExpansionModBlockEntities.KOLTO_TANK.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(KoltoTankBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<KoltoTankTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<KoltoTankTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("kolto_tank");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Kolto Tank");
	}
