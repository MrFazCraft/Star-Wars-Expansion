...
public class WorkspaceBenchTileEntity extends RandomizableContainerBlockEntity implements GeoBlockEntity, WorldlyContainer {
	private final AnimatableInstanceCache cache = GeckoLibUtil.createInstanceCache(this);
	private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(9, ItemStack.EMPTY);
	private final LazyOptional<? extends IItemHandler>[] handlers = SidedInvWrapper.create(this, Direction.values());

	public WorkspaceBenchTileEntity(BlockPos pos, BlockState state) {
		super(StarWarsExpansionModBlockEntities.WORKSPACE_BENCH.get(), pos, state);
	}

	private PlayState predicate(AnimationState event) {
		String animationprocedure = ("" + this.getBlockState().getValue(WorkspaceBenchBlock.ANIMATION));
	...
	public void registerControllers(AnimatableManager.ControllerRegistrar data) {
		data.add(new AnimationController<WorkspaceBenchTileEntity>(this, "controller", 0, this::predicate));
		data.add(new AnimationController<WorkspaceBenchTileEntity>(this, "procedurecontroller", 0, this::procedurePredicate));
	}
	...
	public Component getDefaultName() {
		return Component.literal("workspace_bench");
	}
	...
	public Component getDisplayName() {
		return Component.literal("Workspace Bench");
	}
