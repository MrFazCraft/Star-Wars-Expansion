...
public class BlasterE11RightclickedProcedure {
	public static void execute(LevelAccessor world, double x, double y, double z, Entity entity, ItemStack itemstack) {
			...
			return;
		{
			...
			if (!projectileLevel.isClientSide()) {
				...
				}.getArrow(projectileLevel, 5f / 3f, 0); // Daño reducido a un tercio (≈1.66)
		...
		if (itemstack.getItem() instanceof BlasterE11Item)
